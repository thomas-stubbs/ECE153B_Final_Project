...
void I2C_Initialization(void){
	...
	I2C1->TIMINGR &= ~(I2C_TIMINGR_SCLL | I2C_TIMINGR_SCLH | I2C_TIMINGR_SDADEL | I2C_TIMINGR_SCLDEL | I2C_TIMINGR_PRESC);
	I2C1->TIMINGR |= 7UL << I2C_TIMINGR_PRESC_POS;
	I2C1->TIMINGR |= 10UL << I2C_TIMINGR_SCLDEL_POS;
	I2C1->TIMINGR |= 12UL << I2C_TIMINGR_SDADEL_POS;
	I2C1->TIMINGR |= 40UL << I2C_TIMINGR_SCLH_POS;
	I2C1->TIMINGR |= 46UL << I2C_TIMINGR_SCLL_POS;
